...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>
            <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#updateModal" data-url="{{ route('berita.update',['id'=>$Get->db_berita]) }}" data-nama_berita="{{ $Get->nama_berita }}">Update</button>
            |
            <a href="/berita/delete/{{ $Get->db_berita }}" class="btn btn-danger">Delete</a>
        </td>
    </tr>
    @endforeach
</table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="db_berita" required>
                    </div>
                    <div class="mb-3">
